...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  39, 5 }, { 195,  5 }, { 195, 155 }, { 39, 155 } }
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define EVENT_GCODE_SD_ABORT "M118 A1 action:cancel"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27") - M118 A1 action:cancel for Octoprint integration
 ...
 */
 #define FWRETRACT
  ...
  #endif
  #define RETRACT_LENGTH                 6.25            // (mm) Default retract length (positive value)
  #define RETRACT_LENGTH_SWAP            6.25            // (mm) Default swap retract length (positive value)
  #define RETRACT_FEEDRATE               40.0f        // (mm/s) Default feedrate for retracting
  #define RETRACT_ZRAISE                 0            // (mm) Default retract Z-raise
  #define RETRACT_RECOVER_LENGTH        -0.2f        // (mm) Default additional recover length (added to retract length on recover)
  #define RETRACT_RECOVER_LENGTH_SWAP   -0.2f        // (mm) Default additional swap recover length (added to retract length on recover from toolchange)
  #define RETRACT_RECOVER_FEEDRATE       40.0f        // (mm/s) Default feedrate for recovering from retraction
  #define RETRACT_RECOVER_FEEDRATE_SWAP  40.0f        // (mm/s) Default feedrate for recovering from swap retraction
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define ADVANCED_PAUSE_RESUME_PRIME          PAUSE_PARK_RETRACT_LENGTH  // (mm) Extra distance to prime nozzle after returning from park.
