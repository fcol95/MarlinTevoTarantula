 ...
 */
 #define FWRETRACT
  ...
  #define RETRACT_FEEDRATE               37.5f        // (mm/s) Default feedrate for retracting
  ...
  #define RETRACT_RECOVER_FEEDRATE       37.5f        // (mm/s) Default feedrate for recovering from retraction
  #define RETRACT_RECOVER_FEEDRATE_SWAP  37.5f        // (mm/s) Default feedrate for recovering from swap retraction
