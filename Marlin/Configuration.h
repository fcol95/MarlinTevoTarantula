...
#define NOZZLE_TO_PROBE_OFFSET { 39, -45, -0.65 } // Based on LPA Fanduct V5 for Tarantula Positioning of SN04-N Sensor and new magnetic bed - 0.2mm brass nozzle
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 39, 5, 5, 45 } // (mm) Left, Front, Right, Back insets
